...
public class Flight {
    ...
    public Flight(String originParam, String destinationParam, int depHour, int depMinute, int flightDurationParam,
            int noOfPassengersParam, int priceParam) {
    ...
    public boolean addPassengers(int num) {
        if (noOfPassengers + num == 250) {
            ...
            isFull = true;
            return isFull;
        } else if (noOfPassengers + num > 250) {
            return isFull;
        } else {
            noOfPassengers += num;
            return isFull;
    ...
    public boolean equals(Flight other) {
        if (other.origin == origin && other.destination == destination && other.departure == departure
    ...
    public String toString() {
        ...
        return "Flight from " + origin + " to " + destination + " departs at " + departure.toString() + ". "
                + isFullString + ".";
    }
